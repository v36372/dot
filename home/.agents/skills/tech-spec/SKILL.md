...
Treat `../coding-standards/SKILL.md` as the standards source of truth and follow the project's established testing workflow.
...
### 7. Write the test plan

Follow the project's testing standards and plan vertical implementation slices. Avoid a horizontal "all tests first, all code later" plan unless the project explicitly uses that workflow.
